...
import { ActionList } from "@/app//utils";

const Toolbar = (props: { editor: Editor }) => (
  <div className="flex flex-wrap items-center gap-2 rounded-xl bg-slate-200/50 px-2 py-1 ring-2 ring-white dark:bg-slate-800/50 dark:ring-slate-900">
    {Object.values(ActionList)
      .flat()
      .map((action) =>
        action.type === "item" ? (
          <button
