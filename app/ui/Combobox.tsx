        ...
        <div className="relative mt-1">
          <div className="flex w-full cursor-pointer items-center justify-between gap-4 rounded-lg bg-transparent focus:outline-none">
            <BaseCombobox.Input
              ...
              className="flex w-full cursor-pointer items-center justify-between gap-4 rounded-lg border border-white bg-transparent px-4 py-2 ring-1 ring-white focus:border-teal-500 focus:outline-none focus:ring-4 focus:ring-teal-400 focus:ring-offset-2 dark:border-slate-900 dark:ring-slate-900"
            />
